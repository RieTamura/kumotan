...
くもたんは、Blueskyのタイムラインを読みながら英語を学べるアプリです。
...
【タイムラインで学習】
フォローしている人の投稿を読みながら、気になる英単語を長押しするだけで単語帳に追加できます。

【自分だけの単語帳】
保存した単語は自動で単語帳に登録。翻訳や例文も一緒に保存されるので、後から復習しやすい！

【投稿を調べる】
投稿全体をワンタップで翻訳・解析。文脈を理解しながら学習できます。

【学習進捗の記録】
学習した単語数や日々の進捗を確認できます。Blueskyに進捗をシェアすることも可能！

【画像・リンク対応】
投稿内の画像やリンクも表示。文脈を理解しやすくなります。

【スレッド表示】
投稿をタップすると返信も含めたスレッド全体を確認できます。

■ 対応言語
日本語 / English

■ ご利用にあたって
・Blueskyアカウントでのログインが必要です
・翻訳機能にはDeepL APIキー（無料プランあり）が必要です
...
2. **単語選択**
   - 投稿内の英単語を長押しして選択している状態
   - WordPopupモーダルが表示されている
