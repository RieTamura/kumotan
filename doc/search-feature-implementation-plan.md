...
### Phase 1
1. [ ] **[Types]** `WordFilter` に `searchQuery` を追加
2. [ ] **[Database]** `getWords` に LIKE 検索条件を追加
3. [ ] **[Component]** `SearchBar.tsx` コンポーネントを作成
4. [ ] **[Screen]** `WordListScreen.tsx` に検索バーを統合
5. [ ] **[i18n]** 多言語対応の翻訳キー追加
6. [ ] **[Test]** 動作確認（英語/日本語/定義での検索、空文字、フィルタとの組み合わせ）
